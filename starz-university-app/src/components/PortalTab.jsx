...
const PortalTab = () => {
  ...
  const openInNewTab = () => {
    window.open('https://starzportal.net', '_blank');
  };
    ...
    <div className="relative h-full">
      ...
      <div className="starz-primary p-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <User size={24} className="starz-text-gold" />
      ...
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-white z-10">
          <div className="text-center">
            ...
            <p className="starz-font-sans text-gray-600">Loading student portal...</p>
          </div>
        </div>
      )}
      ...
      <iframe
        id="portal-iframe"
        src="https://starzportal.net"
        className="iframe-container"
        onLoad={handleIframeLoad}
        onError={handleIframeError}
        title="Starz University Student Portal"
